...
----se hixo ksksk KDNKDKDD pruebaASHOIDHASHFIAHFA�EI
...
BEGIN
    CREATE TABLE horarios (
        ...
        Salon NVARCHAR(50),
        session_id UNIQUEIDENTIFIER DEFAULT NEWID() -- ?? Identificador �nico por carga
    );
END
GO
